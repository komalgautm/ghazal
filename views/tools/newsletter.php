...
if (isset($_GET['email'])) {
    ...
    $email_template = cdp_getEmailTemplates(12);
} else {

    $email_template = cdp_getEmailTemplates(4);
}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                                ...
                                                                <input class="form-control" name="recipient" type="text" value="<?php if (isset($_GET['email'])) {
                                                                                                                                    echo $_GET['email'];
