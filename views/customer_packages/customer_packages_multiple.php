                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 ">
                                            ...
                                            <div class="input-group">
                                                <select class="select2 form-control" id="sender_address_id" name="sender_address_id" disabled="" style="width: 97%;">
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input onkeypress="return cdp_soloNumeros(event)" type="text" class="form-control" name="price_purchase" id="price_purchase" placeholder="<?php echo $lang['left67'] ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
