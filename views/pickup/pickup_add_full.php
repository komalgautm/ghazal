...
if (isset($_POST["create_invoice"])) {
    ...
    if (count($_FILES['filesMultiple']['name']) > 0 && $_FILES['filesMultiple']['tmp_name'][0] != '') {
        ...
        foreach ($_FILES["filesMultiple"]['tmp_name'] as $key => $tmp_name) {
            ...
            cdp_insertOrdersFiles($order_id, $target_file, $image_name, date("Y-m-d H:i:s"), '0');
        }
    }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="select2 form-control custom-select" id="recipient_id" name="recipient_id" disabled style="width: 97%;">
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="select2 form-control" id="recipient_address_id" name="recipient_address_id" disabled="" style="width: 97%;">
                                                </select>
