...
if (isset($_POST["create_invoice"])) {
    ...
    for ($count = 0; $count < $_POST["total_item"]; $count++) {
        ...
        $weight_item = cdp_sanitize($_POST["order_item_weight"][$count]);
        $length_item = cdp_sanitize($_POST["order_item_length"][$count]);
        $width_item = cdp_sanitize($_POST["order_item_width"][$count]);
        $height_item = cdp_sanitize($_POST["order_item_height"][$count]);
        $declared_value_item = cdp_sanitize($_POST["order_item_declared_value"][$count]);
        ...
        $email_template = cdp_getEmailTemplates(21);
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 ">
                                            ...
                                            <div class="input-group">
                                                <select class="select2 form-control" style="width: 97%;" id="sender_address_id" name="sender_address_id" disabled="">
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="select2 form-control custom-select" style="width: 97%;" id="recipient_id" name="recipient_id" disabled>
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="select2 form-control" style="width: 97%;" id="recipient_address_id" name="recipient_address_id" disabled="">
                                                </select>
