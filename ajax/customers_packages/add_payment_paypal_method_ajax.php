...
$amount = cdp_sanitize($_POST['purchase_units'][0]["payments"]["captures"][0]["amount"]['value']);
$currency_code = cdp_sanitize($_POST['purchase_units'][0]["payments"]["captures"][0]["amount"]['currency_code']);
$status = cdp_sanitize($_POST['purchase_units'][0]["payments"]["captures"][0]["status"]);
$payment_id = cdp_sanitize($_POST['purchase_units'][0]["payments"]["captures"][0]["id"]);
$gateway = 'PayPal';
