...
$sql = "SELECT * FROM cdb_payments_gateway  where type_transaccition_courier= 'Online Shipping' and payment_transaction LIKE '%" . $search . "%' $sWhere  order by id desc 
			 ";
			...
			<tbody id="projects-tbl">
				...
				<?php } else { ?>
					...
					foreach ($data as $row) {
						...
						$db->cdp_query("SELECT * FROM cdb_customers_packages  where CONCAT(order_prefix, order_no)= '" . $row->order_track . "'");
