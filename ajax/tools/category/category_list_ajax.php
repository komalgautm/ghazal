			...
			<?php foreach ($data as $row) { ?>
				<tr>
					...
					<td class="text-center">
						...
						<a id="item_<?php echo $row->id; ?>" onclick="cdp_eliminar('<?php echo $row->id; ?>');" class="delete" data-rel="<?php echo $row->name_item; ?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-category16'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
					</td>
				</tr>
			<?php } ?>
