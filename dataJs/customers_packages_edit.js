...
function cdp_cal_final_total() {
    ...
    var order_total_reexp = $('#order_total_reexp').val();
    var reexpedicion_value = parseFloat(order_total_reexp);
    ...
    for (var i = 1; i <= count; i++) {
        ...
        if (sumador_valor_declarado > core_min_cost_declared_tax) {
            ...
            total_valor_declarado = sumador_valor_declarado * order_declared_value / 100;
        }
