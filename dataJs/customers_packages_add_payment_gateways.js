...
if (active_paystack == 1) {
    ...
    function cdp_addPaymentPaystackSuccess(details) {
        ...
        $.ajax({
            ...
            url: './ajax/customers_packages/add_payment_paystack_method_success_ajax.php?order_id=order_id=' + order_id + '&track_order=' + track_order + '&customer=' + order_sender_id + '&firstname=' + firstname + '&lastname=' + lastname,
            method: 'post',
            data: details,
            success: function (data) {
